...
- **[rpa-bot-dev](./skills/engineering/rpa-bot-dev/SKILL.md)** — Structured RPA bot development from discovery to implementation for UiPath and Power Automate Desktop.
